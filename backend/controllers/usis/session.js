...
exports.parseSessionCode = (sessionCode) => {
  ...
  const semester = Object.keys(SEMESTER_DISTANCES).find(
    (key) => SEMESTER_DISTANCES[key] === remainder + 3
  );
...
console.log(
  "Generate Session Code (Fall 2021):",
  exports.generateSessionCode("fall", 2021)
); // 627116
console.log(
  "Generate Session Code (Spring 2025):",
  exports.generateSessionCode("spring", 2025)
); // 627126
console.log(
  "Generate Session Code (Summer 2026):",
  exports.generateSessionCode("summer", 2026)
); // 627130
